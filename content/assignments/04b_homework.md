...
1. Get set up with IU Research Computing accounts: [instructions here](https://uits.iu.edu/services/accounts-and-email/research/index.html)
  ...
  * Some of the forms will ask you whether you need to store HIPAA data (health-related data); answer "no" to this question, unless you have another role on campus that requires you to handle HIPAA data
2. Download, install, and configure ThinLinc to connect to RED Desktop: [instructions here](https://go.iu.edu/8uXk)
3. Read about [RED Desktop](https://go.iu.edu/8uXl) and how to use it
