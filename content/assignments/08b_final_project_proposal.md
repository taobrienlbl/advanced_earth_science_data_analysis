...
1. an overview of what your final project will accomplish
1. an indication of which advanced topic your project will use: parallelization or machine learning
1. a timeline for completing the various stages of the project, both within class time and outside of class time
    * assume that the last 5 weeks of lab (at least) will have an hour or more of time devoted to working on your project
...
1. a mockup (e.g., sketch) of your main publication-quality figure
...
As a reminder, for your [final project](https://iu.instructure.com/courses/2330390/assignments/18106104), you will need to submit a link to your github repository containing one or more notebooks documenting a final project.  Quoting from the final project description, the projects will: 
...
```{note}
Due date and submission details can be found in [Canvas](https://iu.instructure.com/courses/2330390/assignments/18106103).
```