...
1. apply the concepts from [lesson 07](../07_parallelization_intro/07_parallelization_intro.md) to parallelize the loop that iterates over the $\pi$ terms (don't use `simplempi` here)
