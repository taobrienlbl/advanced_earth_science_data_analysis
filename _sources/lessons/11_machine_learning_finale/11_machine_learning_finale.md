...
* Finish [](./11_apply_ml_to_data.md)

## PREVIEW | Class Overview:

(45 mins) Complete [](../09_machine_learning_intro/09_workalong_machine_learning_basics.ipynb)

(60 mins) [](./11_apply_ml_to_data.md)

(45 mins) Work on final project
