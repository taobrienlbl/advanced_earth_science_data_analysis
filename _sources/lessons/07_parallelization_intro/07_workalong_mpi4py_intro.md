...
1. Run your code in parallel: `I_MPI_FABRICS=shm srun -n 9 python3 -u 07_workalong.py`
    * Explanation:
        * `I_MPI_FABRICS=shm`: a workaround I had to add...unclear why
        ```{note}
        It may not be necessary to include this, and it may in fact produce errors for some.  It is a workaround to deal with an issue that does not seem to affect everyone.
        ```
